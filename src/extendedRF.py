...
class extendedRF:
    ...
    def BMOptimization(self,Budget):
        ...
        self.feature_selection, self.total_cost, self.total_error = _BMOptimization(self.error_estimation_test, CV, self.CF_unique, Budget, self.distinct_mod,self.m_comb)
    ...
    def BMOptimization_universal(self,Budget,n):
        ...
        self.feature_selection, self.total_cost, self.total_error = _BMOptimization_universal(universal_error, CV, self.CF_unique, Budget, self.distinct_cat,self.m_comb,n)